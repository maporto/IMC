package br.com.marcosporto.imc
...
import br.com.marcosporto.imc.extensions.format
import br.com.marcosporto.imc.watchers.DecimalTextWatcher
        ...
        when {
            ...
            altura == 0.0 -> {
                ...
                when(val imc = peso / (altura * altura)) {
                    in 0.0..18.5 -> configureIMC(imc, R.drawable.masc_abaixo, R.string.magreza)
                    in 18.6..24.9 -> configureIMC(imc, R.drawable.masc_ideal, R.string.peso_normal)
                    in 25.0..29.9 -> configureIMC(imc, R.drawable.masc_sobre, R.string.sobre_peso)
                    in 30.0..34.9 -> configureIMC(imc, R.drawable.masc_obeso, R.string.obesidade_grau_i)
                    in 35.0..39.9 -> configureIMC(
                            imc,
                            R.drawable.masc_extremo_obeso,
                            R.string.obesidade_grau_ii
                    )
                    else -> configureIMC(imc, R.drawable.masc_extremo_obeso, R.string.obesidade_grau_iii)
                }
            }
        }
    }
